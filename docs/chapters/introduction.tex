...
\section{Objetivos}
O objetivo deste trabalho é fazer uma revisão da literatura sobre regressão simbólica, apresentando suas principais características, técnicas e aplicações. Além disso, será desenvolvida uma interface web para facilitar a exploração de algoritmos de regressão simbólica, permitindo que usuários possam experimentar com diferentes conjuntos de dados e parâmetros do algoritmo. Dentre os objetivos específicos da plataforma proposta, podemos destacar:
...
Este trabalho está organizado da seguinte forma: o capítulo 2 traz uma revisão da literatura atual sobre regressão simbólica, além de explorar os conceitos necessários para entendimento das principais implementações de algoritmos de regressão simbólica. O capítulo começa com uma revisão dos principais conceitos relacionados a regressão e algoritmos genéticos, depois o capítulo explica como algoritmos de regressão simbólica funcionam. Em seguida, o capítulo 2 discorre sobre as principais implementações de regressão simbólica atuais e, por fim, há uma breve comparação entre as principais ferramentas de regressão simbólica disponíveis atualmente. Os próximos dois capítulos apresentam, respectivamente, a proposta de plataforma web para exploração de algoritmos de regressão simbólica e a linguagem de consulta proposta para essa exploração. O capítulo 5 apresenta os resultados obtidos com a implementação da plataforma e, por fim, o capítulo 6 traz as conclusões do trabalho e sugestões para trabalhos futuros.
