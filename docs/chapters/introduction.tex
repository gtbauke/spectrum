...
A plataforma também permitirá a criação de pipelines completos para manipulação de conjuntos de dados de forma totalmente autônoma, permitindo a construção de processos complexos que dependem de modelos de regressão simbólica, podendo ser utilizada para mecanismos de previsão ou para alimentação de outro sistemas.
