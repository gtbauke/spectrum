...
try:
    from app.core.domain.base import RootDomainModel
...
def generate(target_model_name: str | None = None):
    ...
    frontend_dir = repo_root / "packages" / "frontend" / "app" / "schemas" / "generated"
    ...
    run_biome(repo_root / "packages" / "frontend")
...
if __name__ == "__main__":
    ...
    if args.file:
        ...
        try:
            ...
            print(
                f"Error: The file {args.file} is not inside the backend package directory.")
            sys.exit(1)
