...
\begin{epigrafe}
  \begin{vplace}[0.7]
    \textit{"Computadores são incrivelmente rápidos, precisos e estúpidos; humanos são incrivelmente lentos, imprecisos e brilhantes; juntos eles são poderosos além da imaginação."}
  \end{vplace}
\end{epigrafe}
