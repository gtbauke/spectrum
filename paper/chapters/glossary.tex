...
\begin{description}
    ...
    \item[Clean Architecture:] Padrão arquitetural de software estruturado em camadas concêntricas visando a separação de responsabilidades e isolamento da lógica de negócio.
