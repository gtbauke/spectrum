...
from .create_job_version import CreateJobVersion


class UpdateJobVersion(BaseModel):
    ...
    def to_create_job_data(self, latest_version: JobVersion) -> CreateJobVersion:
