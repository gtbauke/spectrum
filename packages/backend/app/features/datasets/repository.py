...
class IArtifactsRepository(IImmutableRepository[Artifact, ArtifactWhere, ArtifactFilter], Protocol):
    pass


class IDatasetsRepository(IMutableRepository[Dataset, DatasetWhere, DatasetFilter], Protocol):
    pass
